...
IPizza.samplePayment = function(project, urlPrefix, options, callback) {
    ...
    var payment = new IPizza(project.bank, testFields, charsetValue);
...
IPizza.detectCharset = function(bank, fields) {
    ...
    var defaultCharset = bank.defaultCharset;
...
IPizza.prototype.validateSignature = function(callback) {
    ...
    tools.opensslVerify(
        ...
        this.charset, (function(err, success) {
            if (err) {
                return callback(err);
            }
            callback(null, {
...
IPizzaValidator.prototype.validate_VK_REC_ID = function() {
    var value = (this.fields.VK_REC_ID || '').toString();
...
IPizzaValidator.prototype.validate_VK_ACC = function() {
    var field = 'VK_ACC';
    var value = (this.fields[field] || '').toString();

    var clen = IBAN.countries[this.bank.country].length - 6;
    var bban = value.substr(-clen);
...
IPizzaValidator.prototype.validate_VK_DATETIME = function() {
    var value = (this.fields.VK_DATETIME || '').toString();
...
IPizzaValidator.prototype.validate_VK_TIME_LIMIT = function() {
    ...
    var value = (this.fields.VK_TIME_LIMIT || '').toString();
...
IPizzaValidator.prototype.validate_VK_PANK = function() {
    ...
    var value = (this.fields.VK_PANK || '').toString();
...
IPizzaValidator.prototype.validate_VK_REPLY = function() {
    var value = (this.fields.VK_REPLY || '').toString();
...
IPizzaValidator.prototype.validate_VK_RID = function() {
    var value = (this.fields.VK_RID || '').toString();
...
IPizzaValidator.prototype.validate_VK_NONCE = function() {
    var value = (this.fields.VK_NONCE || '').toString();
...
IPizza.generateForm = function(payment, project, callback) {
    tools.incrTransactionCounter(project.uid, function(err, transactionId) {
        if (err) {
            return callback(err);
        }
                ...
                fetchUrl(url, {
                    ...
                    if (err) {
                        payment.autoResponse = {
                            ...
                            method: method,
                            url: url,
                            fields: payload ? Object.keys(fields).map(function(key) {
                                return {
                                    key: key,
                                    value: fields[key]
                                };
